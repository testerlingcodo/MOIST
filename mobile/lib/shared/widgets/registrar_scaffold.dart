...
class RegistrarScaffold extends StatelessWidget {
  final Widget child;
  const RegistrarScaffold({super.key, required this.child});
  ...
  Widget build(BuildContext context) {
    ...
    const titles = {
      ...
      '/registrar/enrolled': 'Enrolled Students',
      '/registrar/enrollments': 'Enrollments',
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(titles[location] ?? 'Registrar'),
        actions: [
          IconButton(
