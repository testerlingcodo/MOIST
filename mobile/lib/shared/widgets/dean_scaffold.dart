...
class DeanScaffold extends StatelessWidget {
  final Widget child;
  const DeanScaffold({super.key, required this.child});
  ...
  Widget build(BuildContext context) {
    ...
    const titles = {
      '/': 'Dean Portal',
      '/dean/subjects': 'Subjects',
      '/dean/students': 'Students',
      '/dean/enrolled': 'Enrolled Students',
      '/dean/grades': 'Grades',
      '/dean/enrollments': 'Enrollment Evaluation',
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(titles[location] ?? 'Dean Portal'),
        actions: [
          IconButton(
