...
class _LoginScreenState extends State<LoginScreen>
  ...
  Future<void> _submit() async {
    ...
    try {
      await auth.login(_idCtrl.text.trim(), _passCtrl.text);
    } catch (e) {
      if (!mounted) return;
                        ...
                        child: Padding(
                          ...
                          child: Image.asset('assets/images/moist-seal.png',
                            ...
                            errorBuilder: (_, __, ___) => const Icon(
                              Icons.admin_panel_settings_rounded, size: 52, color: Colors.white)),
                        ),
                      ),
                      ...
                      child: Form(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text('Sign in to manage courses and exams',
